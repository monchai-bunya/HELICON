...
dir_save = 'result_ttotal'
if not path.exists(dir_save):
  os.mkdir(dir_save)

save_folder = './result_ttotal/' 

path_name = save_folder + "multiarms-qtable.pkl"
count_selectnpy = save_folder + "count_select.npy"
ad_selectnpy = save_folder + "ad_select.npy"
count_select = save_folder + "count_select"
ad_select = save_folder + "ad_select"
ddlist = save_folder + "ddlist.txt"
...
result_node_select = save_folder + "result_node_select.csv"
...
node_select = save_folder + "node_select.txt"
...
#tcap4.write(',')
tcap5.write(str(dataset_full[ad]))
